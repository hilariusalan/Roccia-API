        ...
        <div class="w-full max-w-md py-14 px-11 bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300 ease-in-out">
            ...
            <form action="{{ route('auth.verif') }}" method="post">
                ...
                <div class="relative mb-6">
                    ...
                    <input type="email" id="email-address-icon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="nama@email.com" required>
                </div>
